...
public class UserAuthProvider {
    ...
    public Authentication validateToken(String token) {
        ...
        Kullanici kullanici = securityDaoService.findUserByEmail(decoded.getIssuer());

        return new UsernamePasswordAuthenticationToken(kullanici, null, Collections.emptyList());
    }
}
